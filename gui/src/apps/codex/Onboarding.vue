  ...
  <div class="h-full overflow-y-auto cc-thin-scroll">
    <div class="mx-auto max-w-[720px] px-8 py-12 space-y-8">
      <div>
        ...
        <div class="text-[24px] font-bold">欢迎使用 Codex</div>
        <p class="mt-3 text-[13.5px] leading-[1.7]" style="color:#4a3826">
          Codex 是 OpenAI 的命令行 coding agent。本应用是它在 AIOS 里的原生面板 —— 聊天 · 会话回放 · AGENTS.md · config.toml · Skills / MCP 一页看全。
        </p>
        <p class="mt-2 text-[12px]" style="color:#6b5a46">使用前需要先装 CLI。</p>
      </div>

      <div class="space-y-5">
        <div class="text-[13px] font-bold uppercase tracking-wider" style="color:#8a7965">在终端里跑一条命令</div>
      ...
      <div class="flex items-center gap-3">
        ...
        <a href="https://github.com/openai/codex" target="_blank" rel="noopener" class="text-[12px] underline" style="color:#5c4332">查看 GitHub ↗</a>
      </div>
    </div>
  </div>
</template>
...
const commands = [
  { os: 'npm (推荐)', icon: '📦', cmd: 'npm install -g @openai/codex' },
  { os: 'macOS / Homebrew', icon: '🍎', cmd: 'brew install codex' }
];
